                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($category->is_active): ?>
                                    <span
                                        class="label label-success"><?= Yii::t('RequestSupportModule.base', 'Active') ?></span>
                                <?php else: ?>
                                    <span
                                        class="label label-default"><?= Yii::t('RequestSupportModule.base', 'Inactive') ?></span>
                                <?php endif; ?>
                            </td>
                            <td>
                                <?= Html::a(
                                ...
                                <?= Button::danger()
                                    ->icon('trash')
                                    ->link(['/requestSupport/category/delete', 'id' => $category->id, 'contentContainer' => $contentContainer])
                                    ->xs()
                                    ->title(Yii::t('RequestSupportModule.base', 'Delete'))
                                    ->confirm(
                                        Yii::t('RequestSupportModule.base', 'Are you sure you want to delete this category?'),
                                        $category->requests ? Yii::t('RequestSupportModule.base', 'IMPORTANT: {nbRequests} are using this category. They will all be definitively deleted too!', ['nbRequests' => count($category->requests)]) : '',
                                    )
                                ?>
                            </td>
                        </tr>
